...
const testi = [
	{
		speech: 'Lorem ipsum dolor sit, amet consectetur rro fuga minima necessitatibus repellendus. Veniam suscipit excepturi rem aliquam officiis.',
		name: 'David',
		occupation: 'Social Influencer',
	},
	{
		speech: 'Nesciunt natus ullam iusto, maiores facere consectetur minima necessitatib adipisicing elit. Autem porro',
		name: 'Neymar',
		occupation: 'Athlete',
	},
	{
		speech: 'provident neque obcaecati, quo consequatur delectus s ullam iusto, maiores facere consecte',
		name: 'Ronaldo',
